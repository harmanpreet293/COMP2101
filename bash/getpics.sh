...
#improvement: downloading a tarfile to pictures directory and checking weather the tar file is already there or not
...
#improvement: extracting the tarfile if it is there and removing the tarfile after extraction
